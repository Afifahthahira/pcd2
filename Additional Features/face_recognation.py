...
recognizer.read('H:/SEMESTER 5/Prak. Pengolahan Citra Digital/pcd2/Additional Features/trainer.yml')

# Load peta label dari file
id_to_label = {}
with open('H:/SEMESTER 5/Prak. Pengolahan Citra Digital/pcd2/Additional Features/labels.txt', 'r') as f:
    for line in f:
